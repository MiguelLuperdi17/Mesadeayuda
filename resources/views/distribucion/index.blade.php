                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select select33"
                                                        ...
                                                        @foreach($meses as $mes)
                                                            <option value="{{$mes}}" @if($mes == 'Enero') selected disabled @endif>{{$mes}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="mb-3">
            ...
            <div class="px-3 mb-5">
                <div class="row justify-content-between">
                    <div
                        ...
                        <h1 class="fs-3 pt-3">587</h1>
                        <p class="fs--1 mb-0">Total de líneas</p>
                    </div>
                    <div
                        ...
                        <h1 class="fs-3 pt-3">10</h1>
                        <p class="fs--1 mb-0">Planes</p>
                    </div>
                    <div
                        ...
                        <h1 class="fs-3 pt-3">9,831.67</h1>
                        <p class="fs--1 mb-0">Pago por líneas</p>
                    </div>
                    <div
                        ...
                        <h1 class="fs-3 pt-3">4,943.02</h1>
                        <p class="fs--1 mb-0">Pago por equipos</p>
                    </div>
                    <div
                        ...
                        <h1 class="fs-3 pt-3">0</h1>
                        <p class="fs--1 mb-0">Líneas nuevas</p>
                    </div>
                    <div
                        ...
                        <h1 class="fs-3 pt-3">9,831.67</h1>
                        <p class="fs--1 mb-0">Total Dic-2024</p>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="section">
                        <div class="card">
                            <div class="card-body">
                                <h4 style="font-weight: 900">Pendientes de aprobación del Mes.</h4>

                                <div class="table-responsive table-reponsive-sm scrollbar" style="height: 325px">
                                    <table class="table table-striped table-bordered" style="min-height: 310px; text-align: center; vertical-align: middle;">
                                        <thead>
                                        <tr style="background: #2ba708;">
                                            <th scope="col" style="font-weight: 700">LÍNEA</th>
                                            <th scope="col" style="font-weight: 700">C. ANT</th>
                                            <th scope="col" style="font-weight: 700">C. ACT</th>
                                            <th scope="col" style="font-weight: 700">ACCIÓN</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        @foreach($p_costos as $p_costo)
                                            <tr id="row-{{$p_costo->id}}">
                                                <td>{{$p_costo->linea->numero}}</td>
                                                <td>{{$p_costo->linea->costo_actual}}</td>
                                                <td>{{$p_costo->total}}</td>
                                                <td style="text-align: center;">
                                                    <button class="btn btn-success" style="width: 50%;" onclick="aprobar('{{$p_costo->id}}')">Aprobar</button>
                                                </td>
                                            </tr>
                                        @endforeach
                                        </tbody>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="section">
                        <div class="card">
                            <div class="card-body" style="min-height: 300px; width: 100%;">
                                <div class="echart-basic-bar-chart-example" id="barChart3" style="min-height: 350px;
                                    width: 100%;"></div>
                            </div>
                        </div>
                    </div>
