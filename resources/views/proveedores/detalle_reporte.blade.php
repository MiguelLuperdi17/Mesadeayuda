        ...
        <div class="content">
            <section class="pt-1 pb-9">
                <div class="row align-items-center justify-content-between g-3 mb-4">
                    <div class="col-auto">
                        <h2 class="mb-0">Tickets Proveedores -
                        @if ($tipo == "analista")
                            Registrados por: {{$observado->username}}
                        @else
                            {{$observado}}
                        @endif
                    </h2>
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <table id="users-table" class="table table-striped table-bordered"
                                                ...
                                                <thead>
                                                    <tr>
                                                        <th
                                                            style="width: 25%;vertical-align: middle;text-align: -webkit-center;">
                                                            Correlativo
                                                        </th>
                                                        <th
                                                        ...
                                                        <th style="width: 20%">Fecha / SLA</th>
