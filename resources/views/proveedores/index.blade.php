        ...
        <div class="content">
            <section class="pt-1 pb-9">
                <div class="row align-items-center justify-content-between g-3 mb-4">
                    <div class="col-auto">
                        <h2 class="mb-0">Tickets Proveedores</h2>
                    </div>
                </div>
                                        ...
                                        <div class="table-responsive">
                                                ...
                                                <div class="modal-dialog modal-xl">
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="miModalLabel">Crear nuevo ticket
                                                                proveedor</h5>
                                                        ...
                                                        <div class="modal-body">
                                                            <form method="POST" name="formArchivo" class="cliente"
                                                                action="{{ url('crear_ticket_prov') }}" id="formArchivo"
                                                                        ...
                                                                        <div class="col-md-12">
                                                                                ...
                                                                                <select class="form-select select33"
                                                                                    ...
                                                                                    <option value="">-- Selecciona el proveedor --</option>
                                                                                        @foreach ( $proveedores as $provedor)
                                                                                            <option value="{{$provedor->id}}"> {{$provedor->username}}</option>
                                                                                        @endforeach
                                                                                </select>
                                                                            ...
                                                                            <div class="mb-0">
                                                                                <label class="form-label"
                                                                                    ...
                                                                                    detalle de la solicitud</label>
                                                                                <textarea class="form-control" id="requerimiento" name="requerimiento" placeholder="Detalle de ticket" rows="3"
                                            ...
                                            <table id="users-table" class="table table-striped table-bordered"
                                                ...
                                                <thead>
                                                    <tr>
                                                        <th
                                                            style="width: 20%;vertical-align: middle;text-align: -webkit-center;">
                                                            Correlativo
                                                        </th>
                                                        <th
                                                            style="width: 15%;vertical-align: middle;text-align: -webkit-center;">
                                                            Proveedor
                                                        </th>
                                                        <th style="width: 30%">Detalle</th>
                                                        <th style="width: 15%">Fecha / SLA</th>
                                                    ...
                                                    @foreach ($tickets as $ticket)
                                                        <tr>
                                                            <td
                                                                ...
                                                                Ticket de Requerimiento de <br>Soporte
                                                                LAREDO2025-00{{ $ticket->correlativo }}</td>
                                                            <td
                                                                style="vertical-align: middle;text-align: -webkit-center;">
                                                                {{$ticket->proveedor->username}}</td>
                                                            ...
                                                            <td style="vertical-align: middle;">
                                                                {{ $ticket->fecha_creacion }} <br>
                                                                {{ $ticket->sla_id * 8 }} Horas.
                                                            </td>
                                                            <td style="vertical-align: middle;">
                                                                @if ($ticket->estado == 1)
                                                                    <span
                                                                        class="badge badge-phoenix badge-phoenix-warning">Pendiente</span>
                                                            ...
                                                            <td
                                                                ...
                                                                <button class="btn-xs btn btn-primary"
                                                                    ...
                                                                    data-bs-target="#miModalFinal{{$ticket->id}}"
                                                                    @if ($ticket->estado == 2) disabled @endif>Finalizar</button>
                                                            </td>
                                                        </tr>
                                                        @if ($ticket->estado != 2)
                                                                <div class="modal fade" id="miModalFinal{{$ticket->id}}"
                                                                        ...
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                <h5 class="modal-title"
                                                                                    id="miModalLabel">Finalizar ticket
                                                                                    proveedor</h5>
                                                                                <button type="button"
                                                                                    class="btn-close"
                                                                            ...
                                                                            <div class="modal-body">
                                                                                <form method="POST"
                                                                                    name="formArchivo" class="cliente"
                                                                                    action="{{ url('finalizar_ticket_prov') }}"
                                                                                    id="formArchivo"
                                                                                    enctype="multipart/form-data">
                                                                                    @csrf
                                                                                    <div class="row">
                                                                                        <div class="row">
                                                                                            <div class="col-md-12">
                                                                                                ...
                                                                                                <div class="mb-3">
                                                                                                    <label
                                                                                                        class="form-label"
                                                                                                        for="datetimepicker">Seleccione la fecha y hora</label>
                                                                                                    <input
                                                                                                        class="form-control datetimepicker"
                                                                                                        name="fecha"
                                                                                                        id="datetimepicker"
                                                                                                        type="text"
                                                                                                        placeholder="dd/mm/aaaa hora : minuto"
