...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="{{ asset('/recursos/logo2.png') }}"/>
    ...
    <link href="plantilla/assets/css/pages/error/style-400.css" rel="stylesheet" type="text/css" />
...
<body class="error404 text-center">
        ...
        <div class="row">
            <div class="col-md-4 mr-auto mt-5 text-md-left text-center">
                <a href="index.html" class="ml-md-5">
                    <img alt="image-404" src="{{ asset('/recursos/logo.jpeg') }}" style="width:100px">
                </a>
            </div>
        </div>
    </div>
    <div class="container-fluid error-content">
        <div class="">
            ...
            <p class="error-text mb-4 mt-1">No tiene permisos para esta vista!</p>
