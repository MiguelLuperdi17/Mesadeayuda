    ...
    <div class="content">
        <section class="pt-1 pb-9">
            <div class="row align-items-center justify-content-between g-3 mb-4">
                <div class="col-auto">
                    <h2 class="mb-0">Tickets {{$text}} de: {{$observado->username}}</h2>
                </div>
            </div>
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table id="users-table" class="table table-striped table-bordered">
                                            ...
                                            @foreach($tickets as $ticket)
                                                ...
                                                @if($text === "Finalizados")
                                                    @php
                                                        $fecha_cierre = \Carbon\Carbon::parse($ticket->fecha_cierre)->startOfDay();
                                                                    $fecha_asignacion = \Carbon\Carbon::parse($ticket->fecha_asignacion)->endOfDay();
                                                                    $workingDays = 0;
                                                                    ...
                                                                    $temp = $workingDays - $ticket->atencion->atencion;
                                                    @endphp
                                                @endif
                                                @if($temp > 0)
                                                <tr>
                                                    ...
                                                    <td style="vertical-align: middle;">
                                                        ...
                                                        <font style="font-weight: 900">Tiempo de atención
                                                            esperado: </font>{{$ticket->atencion->atencion}}D
                                                        <br>
                                                        @if($text === "Finalizados")
                                                            <font style="font-weight: 900">Tiempo real de
                                                                atención: </font>
                                                            {{$workingDays}}D
                                                            <br>
                                                        @endif
                                                        ...
                                                        <br>
                                                        <font style="font-weight: 900">F. asignación: </font>{{$ticket->fecha_asignacion}}
                                                        <br>
                                                        @if ($ticket->estado == "T" || $ticket->estado == "F")
                                                        <font style="font-weight: 900">F. cierre: </font>{{$ticket->fecha_cierre}}
                                                        <br>
                                                        @endif
                                                    </td>
                                                    <td style="vertical-align: middle; text-align: -webkit-center;">
