    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="row align-items-center justify-content-between g-3 mb-4">
                <div class="col-auto">
                    <h2 class="mb-0">Reportes de proyectos</h2>
                </div>
            ...
            <div class="px-3 mb-5">
                <div class="row justify-content-between">
                    <div
                        ...
                        <p class="fs--1 mb-0">Total de proyectos</p>
                    </div>
                    <div
                        ...
                        <h1 class="fs-3 pt-3">{{$pend_aprob}}</h1>
                        <p class="fs--1 mb-0">Pendiente de aprobación</p>
                    </div>
                    <div
                        ...
                        <h1 class="fs-3 pt-3">6</h1>
                        <p class="fs--1 mb-0">Vencido</p>
                    </div>
                    <div
                        ...
                        <h1 class="fs-3 pt-3">4</h1>
                        <p class="fs--1 mb-0">Extendido</p>
                    </div>
                    <div
                        ...
                        <h1 class="fs-3 pt-3">4</h1>
                        <p class="fs--1 mb-0">Finalizados</p>
                    </div>
                    <div
                        ...
                        <h1 class="fs-3 pt-3">{{$hitos_ext}}</h1>
                        <p class="fs--1 mb-0">Hitos fuera de tiempo</p>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="section">
                        <div class="card">
                            <div class="card-body" style="min-height: 300px; width: 100%;">
                                <div class="echart-pie-chart-example" id="barChart2" style="min-height: 350px; width: 100%;"></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="section">
                        <div class="card">
                            <div class="card-body">
                                <h4 style="font-weight: 900">Ver detalle de hitos vencidos por Analista</h4>
                                    ...
                                    <table class="table table-striped table-bordered"
                                        ...
                                        <thead>
                                            <tr style="background: #2ba708;">
                                                ...
                                                <th scope="col" style="font-weight: 700">VENCIDO</th>
                                                <th scope="col" style="font-weight: 700">POR VENCER</th>
                                        ...
                                        <tbody>
                                            @foreach ($resumen as $res)
                                                <tr>
                                                    <td>{{ $res['username']}}</td>
                                                    <td>{{ $res['vencidos']}}</td>
                                                    <td>{{ $res['por_vencer']}}</td>
                                                    <td style="text-align: center;">
                                                        <form method="POST" name="formComentario" target="_blank"
                                                            action="{{ url('pendientes_proyecto') }}" id="formComentario"
                ...
                <div class="col-md-6">
                    <div class="section">
                        <div class="card">
                            <div class="card-body">
                                <h4 style="font-weight: 900">Resumen de Proyectos por Analista</h4>
                                ...
                                <div class="table-responsive table-reponsive-sm scrollbar">
                                    <table class="table table-striped table-bordered"
                                        ...
                                        <tbody>
                                            @forelse ($reporteProyectos as $fila)
                                                <tr>
                                                    <td>{{ $fila['username'] }}</td>
                                                    <td>{{ $fila['total_proyectos'] }}</td>
                                                    <td>{{ $fila['proyectos_pendientes'] }}</td>
                                                    <td>{{ $fila['proyectos_finalizados'] }}</td>
                                                    <td>{{ $fila['avance_porcentaje'] }}%</td>
                                                </tr>
                                            @empty
                                                <tr>
                ...
                <div class="col-md-6">
                    <div class="section">
                        <div class="card">
                            <div class="card-body">
                                <h4 style="font-weight: 900">Resumen de Hitos por Analista
                                </h4>
                                <div class="table-responsive table-reponsive-sm scrollbar">
                                    <table class="table table-striped table-bordered"
                                        style="min-height: 310px; text-align: center; vertical-align: middle;">
                                        <thead>
                                            <tr style="background: #2ba708;">
                                                <th>Analista</th>
                                                <th>Total de Hitos</th>
                                                <th>Hitos Completados</th>
                                                <th>% de Avance</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            @forelse ($reporte as $fila)
                                                <tr>
                                                    <td>{{ $fila['username'] }}</td>
                                                    <td>{{ $fila['total_hitos'] }}</td>
                                                    <td>{{ $fila['hitos_completados'] }}</td>
                                                    <td>{{ $fila['avance_porcentaje'] }}%</td>
                                                </tr>
                                            @empty
                                                <tr>
...
<script>
    ...
    var option = {
        title: {
            text: 'Reporte por estado de proyecto'
        },
        tooltip: {},
        xAxis: {
            type: 'category',
...
<script>
    ...
    var option = {
        title: {
            text: 'Proyectos pendientes por usuario'
        },
        tooltip: {},
        xAxis: {
            type: 'category',
...
<script>
    ...
    var nombres = @json($cat_desc);  // Los nombres de las categorías (por ejemplo, los años)
    var valores = @json($cat_total);  // Los valores asociados a cada categoría

    // Extraer las categorías (nombres) y los valores
