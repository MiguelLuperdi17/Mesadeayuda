    ...
    <div class="content">
        <section class="pt-1 pb-9">
            <div class="row align-items-center justify-content-between g-3 mb-4">
                <div class="col-auto">
                    <h2 class="mb-0">Tickets Pendientes de Aprobación</h2>
                </div>
            </div>
                                                        ...
                                                        <form method="POST" name="formComentario"
                                                            ...
                                                            <div class="col-md-12">
                                                                <button class="btn btn-primary" style="width: 100%"
                                                                        type="submit">Aprobar ticket
                                                                </button>
                                                            </div>
                                                        </form>
                                                    </td>
                                                    <td style="vertical-align: middle; text-align: -webkit-center;">
                                                        <form method="POST" name="formAnular"
                                                              class="row-cols-lg-5 g-3"
                                                              action="{{url('rechazar_ticket')}}"
                                                              id="formAnular" enctype="multipart/form-data">
                                                            @csrf
                                                            <input type="hidden" name="ticket_id"
                                                            value="{{ $ticket->id }}">
                                                            <div class="form-floating" style="width: 100%">
                                                                <textarea class="form-control" id="floatingTextarea2"
                                                                          name="comentario"
                                                                          placeholder="Registrar Comentario de Rechazo"
                                                                          style="height: 75px"
